...
import { HiCheck, HiChevronDown, HiChevronUp, HiOutlineShoppingCart} from 'react-icons/hi'
...
const handleShowOrderSummary = () => {
  ...
  return (
    <div>
      ...
      <Link href='/'>
        <div className='relative ml-4 w-8 cursor-pointer lg:hidden h-16 opacity-75 transition
        hover:opacity-100'>
    ...
    <main className='grid grid-cols-1 lg:grid-cols-9'>
        <section className='order-2 max-w-xl lg:col-span-5 mx-auto pb-12 lg:max-w-none
        lg:mx-0 lg:pr-16 lg:pt-16 xl:pl-16 2xl:pl-44'>
        <Link href='/'>
        <div className='relative ml-14 w-12 cursor-pointer lg:inline-flex hidden h-24 opacity-75 transition
        hover:opacity-100'>
            <Image src='https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Apple_logo_black.svg/1667px-Apple_logo_black.svg.png' 
            alt='' layout='fill' objectFit='contain'/>
        </div>
        ...
        <div className='my-8 ml-4 flex space-x-4 lg:ml-14 xl:ml-0'>
            ...
            <div>
                <p className='font-semibold text-sm text-gray-600'>Order #{session_id?.slice(-5)}</p>
